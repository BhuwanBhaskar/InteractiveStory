...
public class Story {
    ...
    public Story()
    {
        stories = new StoryPage[NUMBER];

        stories[0] = new StoryPage(R.mipmap.page0,"On your return trip from studying Saturn's rings, you hear a distress signal that seems to be coming from the surface of Mars. It's strange because there hasn't been a colony there in years. Even stranger, it's calling you by name: \"Help me, %1$s, you're my only hope.\"",
                new Choice("Stop and investigate",1),
                new Choice("Continue home to Earth", 2));
        stories[1] = new StoryPage(
                R.mipmap.page1,
    ...
    public StoryPage getStoryPage(int index)
    {
